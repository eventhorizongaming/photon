...
export const Modules = {
  ...
  Shapes: {
    ...
    convex: (options, x, y, vertices, angle = 0) => new Convex({ ...options, position: [x, y], vertices, angle }),
    heightfield: (options, x, y, heights, elementWidth, angle = 0) => new Heightfield({ ...options, position: [x, y], heights, elementWidth, angle }),
